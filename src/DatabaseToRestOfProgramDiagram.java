...
public interface DatabaseToRestOfProgramDiagram
{
	...
	/*Returns an ArrayList<Object> with two variables: 0 is a Boolean, 1 is a String. The Boolean result is if the
	user file was successfully read or not, and the String is the contents of the user file, if the Boolean is false
	then the String value is null.*/
